        ...
        <form method="GET" class="row g-2">
           ...
           <div class="col-6 col-md-2">
				<select name="kondisi" class="form-select form-select-sm">
					...
					<option value="<?= htmlspecialchars($k['nama_kondisi']) ?>" <?= $filter_kondisi == $k['nama_kondisi'] ? 'selected' : '' ?>>
            ...
            <table class="table table-hover table-bordered mb-0 small">
                <thead class="table-dark">
                    <tr>
						...
						<th class="d-none d-md-table-cell">Keterangan Penempatan</th>
                ...
                <?php else: while($row = mysqli_fetch_assoc($result)): ?>
                    ...
                    <tr>
                       ...
                       <td class="d-none d-md-table-cell">
						...
						<td class="d-none d-md-table-cell text-muted">
							<?= $row['keterangan_penempatan'] ? htmlspecialchars($row['keterangan_penempatan']) : '-' ?>
						</td>
