...
<title>Form PR Barang IT - MCP System</title>
...
<form action="proses_simpan_it.php" method="POST" id="formPRBesar" enctype="multipart/form-data">
...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-start align-items-sm-center gap-2">
        <div>
            <h5><i class="fas fa-boxes-stacked me-2"></i>PURCHASE REQUEST — BARANG IT</h5>
            <small class="opacity-75">Pengajuan ini memerlukan persetujuan minimal 2 Manager </small>
        </div>
            <!-- TAMBAHKAN INI -->
...
<div class="info-alert mb-3 mb-md-4">
    ...
    <div class="alur-badge-wrap mt-1">
        ...
        <span class="alur-arrow">→</span><span class="badge bg-primary">Done</span>
    </div>
...
<div class="row g-2 g-md-3 mb-3 mb-md-4">
    <div class="col-12">
        ...
        <textarea name="keterangan" class="form-control form-control-sm" rows="2"
                  placeholder="Jelaskan tujuan dan keperluan pengajuan barang IT ini..." required></textarea>
    </div>
</div>
...
<tr class="item-row">
    ...
    <td><input type="text" name="kwalifikasi[]" class="form-control form-control-sm input-kwalifikasi bg-light" placeholder="Otomatis..." readonly></td>
    ...
    <td><input type="text" name="satuan[]" class="form-control form-control-sm input-satuan-readonly bg-light" placeholder="Otomatis..." readonly>
	</td>
