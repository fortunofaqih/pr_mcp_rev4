                    ...
                    <tr data-status="<?= $row['status_request'] ?>">
                     ...
                     <td class="text-center">
                            <div class="btn-group">
                                ...
                                <!-- Edit: hanya barang KECIL PENDING/PROSES -->
                                <?php if ($row['kategori_pr'] != 'BESAR' && in_array($row['status_request'], ['PENDING', 'PROSES'])): ?>
                                    <a href="edit_request.php?id=<?= $row['id_request'] ?>"
                                    class="btn btn-sm btn-warning"
                                    title="Edit PR Barang Kecil">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                <?php endif; ?>
                        
                                <!-- Revisi: hanya barang BESAR yang DITOLAK -->
                               <!-- <?php if ($row['kategori_pr'] == 'BESAR' && $row['status_approval'] == 'DITOLAK'): ?>
                                    <a href="edit_request_besar.php?id=<?= $row['id_request'] ?>"
                                    class="btn btn-sm btn-warning"
                                    title="Revisi PR yang Ditolak">
                                        <i class="fas fa-redo me-1"></i>Revisi
                                    </a>
                                <?php endif; ?>-->
								<!-- Revisi: baru agar muncul edit -->
								 <?php 
