...
// 1. AMBIL DATA PR TERLEBIH DAHULU
...
// 2. VALIDASI: APAKAH DATA ADA?
if (!$pr) { 
    header("location:pr.php?pesan=tidak_ditemukan"); 
    exit; 
}

// 3. VALIDASI HAK AKSES (Case Insensitive & Trim Spasi)
...
// 4. VALIDASI STATUS (Boleh edit jika PENDING, PROSES, DITOLAK, atau MENUNGGU APPROVAL)
...
// ============================================================
// AMBIL DATA DETAIL & MASTER UNTUK FORM
// ============================================================
...
// ============================================================
// BUILD OPSI HTML UNTUK JAVASCRIPT
// ============================================================
...
$sats = ["PCS","UNIT","SET","PEKERJAAN","ACARA","DUS","KG","ONS","LITER","METER","LEMBAR","BATANG","ROLL","PACK","DRUM","SAK","PAIL","GALON","BOTOL","TUBE","LONJOR","KOTAK","IKAT","JURIGEN"];
...
$(document).ready(function(){
	 function initSelect2(ctx){
		...
		if(!$('#selectSupplier').hasClass('select2-hidden-accessible')){
			$('#selectSupplier').select2({
				theme:'bootstrap-5', 
				width:'100%',
				dropdownParent: $('body') // ← INI KUNCI UTAMA
			});
		}
	}
      initSelect2();      // untuk baris tabel
	  initSelect2Global(); // untuk supplier & pembeli

    // Set nilai kategori existing
    ...
    $('#addRow').on('click',function(){
        ...
        $('#tbodyItem').append(r);
		initSelect2(r[0]); // ← pastikan passing DOM element, bukan jQuery object
		updateNo();
