...
<head>
    ...
    <title>Master Satuan - MCP System</title>
...
<div class="container">
    <div class="card card-input shadow">
        <div class="card-header bg-mcp py-3 text-center">
            <h5 class="m-0 fw-bold"><i class="fas fa-box me-2"></i> TAMBAH MASTER SATUAN</h5>
        </div>
        <div class="card-body p-4">
            <form action="proses_satuan.php" method="POST">
                <div class="mb-4">
                    <label class="form-label small fw-bold text-muted">NAMA SATUAN</label>
                    <input type="text" name="nama_satuan" class="form-control form-control-lg" placeholder="masukkan nama satuan" required autofocus>
                </div>

                <div class="row g-2">
                    <div class="col-12 mb-2">
                        <button type="submit" class="btn btn-primary w-100 fw-bold py-2 shadow-sm">
                            <i class="fas fa-save me-2"></i> SIMPAN SATUAN
                        </button>
                    </div>
                    <div class="col-12">
                        <a href="data_satuan.php" class="btn btn-outline-secondary w-100 fw-bold">
                            <i class="fas fa-arrow-left me-2"></i> KEMBALI KE DATA SATUAN
                        </a>
                    </div>
                </div>
            </form>
