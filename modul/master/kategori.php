...
<head>
    ...
    <title>Master Kategori - MCP System</title>
...
<div class="container">
    <div class="card card-input shadow">
        <div class="card-header bg-mcp py-3 text-center">
            <h5 class="m-0 fw-bold"><i class="fas fa-box me-2"></i> TAMBAH MASTER KATEGORI</h5>
        </div>
        <div class="card-body p-4">
            <form action="proses_kategori.php" method="POST">
                <div class="mb-4">
                    <label class="form-label small fw-bold text-muted">NAMA KATEGORI</label>
                    <input type="text" name="nama_kategori" class="form-control form-control-lg" placeholder="masukkan nama kategori" required autofocus>
                </div>
                ...
                <div class="row g-2">
                    ...
                    <div class="col-12">
                        <a href="data_kategori.php" class="btn btn-outline-secondary w-100 fw-bold">
                            <i class="fas fa-arrow-left me-2"></i> KEMBALI KE DATA KATEGORI
                        </a>
                    </div>
                </div>
            </form>
